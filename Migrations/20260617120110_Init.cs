        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearlyLicensePrice = table.Column<decimal>(type: "decimal(10,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedSupportYears = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SoftwareDiscounts", x => new { x.DiscountId, x.SoftwareId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SoftwareDiscounts_Software_SoftwareId",
                        column: x => x.SoftwareId,
                        principalTable: "Software",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContractPayments_Contract_ContractId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin", "$2a$11$wLRj5pQICLViNa7e99jtUOA1bn2VD1yIufwwE9/irCHwc3HNamxO.", "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SoftwareDiscounts_SoftwareId",
